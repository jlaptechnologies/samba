[![logo](https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Samba_logo_2010.svg/1280px-Samba_logo_2010.svg.png)](https://www.samba.org)
...
## Configuration
    ...
    sudo docker run -it --rm justinpatchett/samba -h
...
### Setting the Timezone
    ...
    sudo docker run -it -e TZ=EST5EDT -p 139:139 -p 445:445 -d justinpatchett/samba -p
...
through a [GitHub issue](https://github.com/jlaptechnologies/samba/issues).